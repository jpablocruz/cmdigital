...
const Footer = () => {
 return (
  <>
   <footer className="footer bottom-14 md:px-32 py-7 bg-gray-100 text-black font-ibmplex">
    <nav>
   ...
   <footer className="footer bottom-0 px-32 py-4 border-t bg-gray-100 text-black font-ibmplex border-gray-300">
