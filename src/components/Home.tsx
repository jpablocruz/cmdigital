...
const Home = () => {
 return (
  <>
   <div className="flex relative h-[120vh] md:h-[90vh] lg:h-[85vh] z-10 text-black font-mavenPro justify-center border-t-gray-200 border-t-[1px] lg:pl-32 md:pl-4 overflow-hidden">
    <SectionGuidelines />
    <div className="relative flex flex-col md:flex-row md:pl-4">
     ...
     <div className=" lg:w-2/5 h-[100%] hero text-black bg-red-800">
