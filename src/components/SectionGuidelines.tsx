...
const SectionGuidelines = () => {
 return (
  <div
   ...
   className="absolute w-[100%] h-[120vh] md:h-[80vh] lg:h-[75vh] left-0 overflow-hidden box-border bg-gray-50"
  >
   <div
   ...
   >
    <div
     id="Section_container"
     className="relative grid h-[120vh] md:h-[80vh] lg:h-[75vh] mx-auto max-w-[calc(10vw - 0px)] grid-cols-6"
    >
